...
**„Routes Manifest“ / fehlende Lambda-Ziele:** Im Dashboard **Root Directory = `apps/crm`** belassen und **Output Directory leer**. Kein zweites `.next` am Repo-Root (das bricht das Vercel-Next-Bündeln mit `basePath`).
